...
tokenizer = AutoTokenizer.from_pretrained("/data1/model/llama3/unsloth/Llama3-8b")
print("model config loaded")
model = LlamaMeteorForCausalLM.from_pretrained("/data1/model/llama3/unsloth/Llama3-8b", token=hf_auth, device_map="auto", torch_dtype=torch.bfloat16, attn_implementation="flash_attention_2")
